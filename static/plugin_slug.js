...
function handle_json_data(data) {
    ...
    if (valid_page) {
        ...
        document.getElementById("install_command_miq").innerHTML = `<span style="color:pink;">miq</span> <span style="color:lightyellow">install</span> <span style="color:skyblue">${name}</span>`;
    }
    else {
