...
function handle_json_data(data) {
    ...
    if (valid_page) {
        ...
        document.getElementById("install_command_miq").innerHTML = `<span style="color:pink;">local</span> <span style="color:lightyellow">config</span> = <span style="color:lightyellow">require</span> <span style="color:skyblue">'core.config'</span><br><br><br><br>
<span style="color:lightyellow">config</span>.plugins.miq.plugins = {<br><br>
    ...<br><br>
    <span style="color:skyblue">'${name}'</span>,<br><br>
    ...<br><br>
    <br><br>
}
`;
